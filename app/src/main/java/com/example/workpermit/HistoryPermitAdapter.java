...
public class HistoryPermitAdapter extends RecyclerView.Adapter<PermitHolder> {

    List<PermitModel> permitModels;
    HistoryPermitActivity historyPermitActivity;
    Context context;
    FirebaseFirestore db;

    public HistoryPermitAdapter(List<PermitModel> permitModels, HistoryPermitActivity historyPermitActivity) {
        this.permitModels = permitModels;
        this.historyPermitActivity = historyPermitActivity;
    }
    ...
    public PermitHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        permitHolder.setOnClickListener(new PermitHolder.ClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Session session = new Session(historyPermitActivity);
                ...
                db.collection("permit").document(permitModels.get(position).getUid()).update(notification_update)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Intent intent = new Intent(historyPermitActivity, DetailPermitActivity.class);
                                intent.putExtra("no_permit", no_permit);
                                intent.putExtra("permit_uid", uid);

                                historyPermitActivity.startActivity(intent);
                            }
                        });
            }
